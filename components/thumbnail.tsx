...
export default function Thumbnail({ names, images, time, nextImages }: Props) {
  ...
  return (
    <div className="border border-white/10 hover:border-white/20 rounded-xl transition shadow-md sm:shadow-sm sm:hover:shadow-lg shadow-yellow-800/50 overflow-hidden aspect-video w-80 sm:w-120 flex flex-col justify-end relative">
        ...
        <>
          ...
          {images.foreground && (
            <MotionImage
              ...
              width={300}
              height={300}
              className="absolute top-0 bottom-5 -left-5 h-full w-8/12 sm:w-2xs object-cover object-top drop-shadow-2xl grayscale contrast-125 brightness-90 bg-linear-to-r from-black via-black/75 to-transparent"
            />
          )}
          <motion.div
            key={"overlay" + time}
          ...
          <motion.div
            ...
            className="flex justify-center pb-1.5 sm:pb-3 pt-16 sm:pt-20 px-2 sm:px-6 absolute bottom-0 left-0 right-0 bg-linear-to-t from-black to-transparent"
          >
